	...
	foreach my $bc2 (keys %{$counts{$bc1}}){
		foreach my $bc3 (keys %{$counts{$bc1}{$bc2}}){
			foreach my $bc4 (keys %{$counts{$bc1}{$bc2}{$bc3}}){
				...
				print $bc4;
				print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"2"}{"1"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"2"}{"3"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"2"}{"4"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"2"}{"5"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"2"}{"7"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"2"}{"12"};
		print "\t";
		...
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{$bc4}{"3"}{"7"};
		print "\n";
			}
