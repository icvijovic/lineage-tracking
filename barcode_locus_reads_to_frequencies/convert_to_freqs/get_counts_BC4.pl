...
foreach my $bc1 (keys %counts){
	foreach my $bc2 (keys %{$counts{$bc1}}){
		foreach my $bc3 (keys %{$counts{$bc1}{$bc2}}){
			...
			print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{"3"}{"1"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{"3"}{"3"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{"3"}{"4"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{"3"}{"5"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{"3"}{"8"};
		print "\t";
		print $counts{$bc1}{$bc2}{$bc3}{"3"}{"12"};
		print "\t";
